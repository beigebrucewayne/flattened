...
hi  StatusLine                              cterm=reverse  ctermfg=14  ctermbg=0  guibg=#ffffff  guifg=#268bd2
hi  StatusLineNC                            cterm=reverse  ctermfg=11  ctermbg=0  guibg=#ffffff  guifg=#268bd2
