...
hi StatusLine                              cterm=reverse  ctermfg=10  ctermbg=7  guibg=#c0bbab  guifg=#fdf6e3
hi StatusLineNC                            cterm=reverse  ctermfg=12  ctermbg=7  guibg=#c0bbab  guifg=#fdf6e3 gui=ITALIC
